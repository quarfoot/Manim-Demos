...
class PADemo(Scene):
    def construct(self):
        ...
        self.play(VGroup(rectgrp, rlabelgrp).animate.to_edge(LEFT))
        self.wait(2)
        ...
        self.play(LaggedStart(Write(rderive[0]), Write(rderive[1]), lag_ratio=2))
        self.wait(2)
        self.play(FadeOut(rlabelgrp))
        ...
        self.play(FadeIn(plabelgrp))
        self.wait(2)

        ###########
        # section 6 - show derivation
        self.next_section(skip_animations=skip)
        self.play(VGroup(polargrp, plabelgrp).animate.shift(4 * LEFT))
